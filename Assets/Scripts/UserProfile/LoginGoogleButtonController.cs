...
{
	public class LoginGoogleButtonController : ButtonController
	{
		[SerializeField]
		...
		public override void OnClick()
		{
			...
			{
				PlatformSpecificServicesProvider.Services.UserProfile.LogIn_Google();
			}
		}
		...
		public override void UpdateButtonStatus()
		{
			...
			if (!PlatformSpecificServicesProvider.Services.UserProfile.IsLoggedIn_Google())
			{
				Show();
			}
			else
