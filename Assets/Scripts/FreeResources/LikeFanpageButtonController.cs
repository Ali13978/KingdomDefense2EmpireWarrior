...
{
	public class LikeFanpageButtonController : FreeResourcesButtonController
	{
		...
		private void SetGemData()
		{
			...
			gemAmount.text = "+ " + PlatformSpecificServicesProvider.Services.FacebookServices.GetFreeResources("reward_id_like_fanpage").ToString();
		}

		public override void OnClick()
		{
			base.OnClick();
			PlatformSpecificServicesProvider.Services.FacebookServices.LikeFanpage();
			InitData();
		}
