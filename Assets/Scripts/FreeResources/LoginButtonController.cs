...
{
	public class LoginButtonController : FreeResourcesButtonController
	{
		...
		private void SetGemData()
		{
			...
			gemAmount.text = "+ " + PlatformSpecificServicesProvider.Services.FacebookServices.GetFreeResources("reward_id_login").ToString();
		}

		public override void OnClick()
		{
			base.OnClick();
			PlatformSpecificServicesProvider.Services.FacebookServices.LogIn();
			InitData();
		}
